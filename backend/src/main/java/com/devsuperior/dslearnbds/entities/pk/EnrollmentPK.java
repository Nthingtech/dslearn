...
@Embeddable //classe que defini atributos de outra classe (Enrollment)
public class EnrollmentPK implements Serializable { //classe criada como auxilar para fazer a relação  muitos para muitos (user/offer)
